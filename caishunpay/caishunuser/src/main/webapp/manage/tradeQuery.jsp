    ...
    <form class="form-inline" id="trade_form" name="trade_form"
        ...
        <table>
            <tr>
                ...
                <td><input id="time_start_begin" name="time_start_begin" size="14" type="text"
                           value="" readonly class="form_datetime">
                    - <input id="time_start_end" name="time_start_end" size="14" type="text"
                             value="" readonly class="form_datetime">
                </td>
                <td><label>交易来源：</label></td>
                <td>
...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function (data, textStatus, request) {
                ...
                for (var i = 0; i < data.data.length; i++) {
                    ...
                    //应答码
                    if (item.result_code == '0' || item.result_code == '00' || item.result_code == '0000' || item.result_code == '000000') {
                    ...
                    //html += '<a href="javascript:void(0);" onclick="reQueryTrade(' + item.trade_state + ')"><span class="text_blue span_auto_width">同步状态</span></a>&nbsp;&nbsp';
                    //html += '<a href="javascript:void(0);" onclick="reNotifyTrade(' + item.trade_state + ')"><span class="text_blue span_auto_width">通知</span></a>&nbsp;&nbsp';
    ...
    //同步交易状态
    function reQueryTrade(outTradeNo) {
        alert("同步交易状态" + outTradeNo);
    }

    //通知补发
    function reNotifyTrade(outTradeNo) {
        alert("通知补发" + outTradeNo);
    }
