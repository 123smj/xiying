...
<div class="search-well">
    <form class="form-inline" id="mcht_form" name="mcht_form"
          style="margin-top:0px;margin-left: 10px" action="manage/mchtQuery" target="_self">
        <table>
            <tr>
                ...
                <td>
                    <input name="identity_no" id="identity_no" class="input-xlarge form-control"
                           placeholder="接入订单号" type="text">
                </td>
                <td><span><label class="control-label span_auto_width"
                                 for="lunch">状态：</label></span></td>
                <td>
...
<ul class="pager">
    ...
    <li><a href="javascript:void(0);" onclick="mchtQuery(document.getElementById('xzPage').value);">go</a>
    </li>
</ul>
