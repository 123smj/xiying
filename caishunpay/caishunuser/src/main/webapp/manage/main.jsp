...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<%= request.getContextPath()%>/stylesheets/comon.css">
    <link rel="stylesheet" type="text/css"
...
<div id="mainDiv" class="sidebar-nav">
    ...
    --%></div>
<iframe class="content" width="82%" height="auto" scrolling="no"
        src="<%= request.getContextPath()%>/manage/tradeQuery.jsp" id="main_iframe"
        name="main_iframe"></iframe>
