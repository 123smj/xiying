...
<div style="width: 90%; margin: 0px auto; margin-top: 5em; float: none;">
    <div class="panel panel-default">
        ...
        <div class="panel-body ">
            ...
            <form id="loginForm" name="loginForm" class="form-horizontal" action="test/doPay"
                  method="post">
                <div class="form-group">
                    <label for="gymchtId" class="col-sm-3 control-label">
                        商户编号
                    </label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="gymchtId"
                               name="gymchtId" placeholder="请输入商户号" value="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select id="tradeSource" name="tradeSource" class="selectpicker"
                                data-live-search="true" title="请选择渠支付类型">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="notifyUrl"
                               name="notifyUrl" placeholder="请输入通知地址"
                               value="http://112.74.25.79:9999/gyprovider/test/notify.do">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="callBackUrl"
                               name="callBackUrl" placeholder="请输入同步跳转地址"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="key"
                               name="key" placeholder="请输入密钥" value="">
                    </div>
                </div>
