...
public class MobaoPayServiceImpl
    ...
    public QuickpayBean doPrepay(QuickpayParam reqParam, QrcodeChannelInf qrChannelInf) {
        ...
        try {
            ...
            params.put("cardByName", MD5Util.encode((byte[]) reqParam.getCardHolderName().getBytes("UTF-8")));
            ...
            String signValue = "";
            signValue = MD5Util.MD5Encode((String) keyValue);
    ...
    public QuickpayBean doCheckpay(QuickpayBean quickpayBean, QrcodeChannelInf qrChannelInf, String yzm) {
        try {
            ...
            params.put("insCode", "");
            params.put("merId", quickpayBean.getMch_id());
            params.put("yzm", yzm);
            params.put("ksPayOrderId", quickpayBean.getTransaction_id());
            String keyValue = GuangdaUtil.map2HttpParam(params);
            keyValue = String.valueOf(keyValue) + qrChannelInf.getSecret_key();
            String signValue = "";
            signValue = MD5Util.MD5Encode((String) keyValue);
            ...
            if (jsonResult != null) {
                if ("00".equals(jsonResult.get("status")) && "00".equals(jsonResult.get("refCode"))) {
                    ...
                    log.info((Object) ("\u6469\u5b9d\u5feb\u6377\u652f\u4ed8\u4ea4\u6613\u6210\u529f" + quickpayBean.getTradeSn()));
                ...
                quickpayBean.setResult_code((String) jsonResult.get("refCode"));
                quickpayBean.setMessage((String) jsonResult.get("refMsg"));
            } else {
    ...
    public QuickpayBean doQuerypay(QuickpayBean quickpayBean, QrcodeChannelInf qrChannelInf) {
        try {
            ...
            params.put("insCode", "");
            params.put("merId", quickpayBean.getMch_id());
            params.put("orderId", quickpayBean.getOut_trade_no());
            params.put("transDate", quickpayBean.getTime_start());
            String keyValue = GuangdaUtil.map2HttpParam(params);
            keyValue = String.valueOf(keyValue) + qrChannelInf.getSecret_key();
            String signValue = "";
            signValue = MD5Util.MD5Encode((String) keyValue);
    ...
    private String buildSendMessage(LinkedHashMap<String, String> params, QrcodeChannelInf qrChannelInf) {
        String keyValue = GuangdaUtil.map2HttpParam(params);
...
//        String sign = MD5Util.MD5Encode((String) (String.valueOf(signData) + "1FDD2547FA4FB61F"));
