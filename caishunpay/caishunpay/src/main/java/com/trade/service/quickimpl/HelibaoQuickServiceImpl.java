...
implements DaifuService {
    ...
    public BankCardPay doPrepay(BankCardPayRequest reqParam, PayChannelInf qrChannelInf) {
        ...
        try {
            ...
            params.put("P3_userId", String.valueOf(reqParam.getMerchantId()) + StringUtil.getRandom(6));
            ...
            params.put("P19_terminalId", reqParam.getMerchantId());
            ...
            params.put("sign", MD5Util.getHelibaoMd5Sign(params, qrChannelInf.getSecret_key(), "UTF-8"));
            ...
            if (jsonResult != null) {
                if ("0000".equals(jsonResult.get("rt2_retCode"))) {
                    ...
                    yzmParams.put("sign", MD5Util.getHelibaoMd5Sign(yzmParams, qrChannelInf.getSecret_key(), "UTF-8"));
                    String yzmKeyValue = MD5Util.map2HttpParam(yzmParams);
    ...
    public BankCardPay doCheckpay(BankCardPay BankCardPay, PayChannelInf qrChannelInf, String yzm) {
        try {
            ...
            params.put("P2_customerNumber", qrChannelInf.getChannel_mcht_no());
            params.put("P3_orderId", BankCardPay.getOut_trade_no());
            params.put("P4_timestamp", DateUtil.getCurrTime());
            params.put("P5_validateCode", yzm);
            params.put("P6_orderIp", BankCardPay.getMch_create_ip());
            params.put("sign", MD5Util.getHelibaoMd5Sign(params, qrChannelInf.getSecret_key(), "UTF-8"));
            String keyValue = MD5Util.map2HttpParam(params);
            String result = HttpUtility.postData(Environment.HELIBAO_QUICKPAY_URL, keyValue);
            Map jsonResult = (Map)JsonUtil.parseJson(result);
            if (jsonResult != null) {
                BankCardPay.setTransaction_id(StringUtil.trans2Str(jsonResult.get("rt6_serialNumber")));
                ...
                if ("0000".equals(jsonResult.get("rt2_retCode")) && "SUCCESS".equals(jsonResult.get("rt9_orderStatus"))) {
                    ...
                    log.info((Object)("\u5408\u5229\u5b9d\u5feb\u6377\u652f\u4ed8\u4ea4\u6613\u6210\u529f" + BankCardPay.getTradeSn()));
                } else {
                    BankCardPay.setTrade_state(TradeStateEnum.PAYERROR.getCode());
                }
                BankCardPay.setResult_code((String)jsonResult.get("rt2_retCode"));
                BankCardPay.setMessage((String)jsonResult.get("rt3_retMsg"));
            } else {
    ...
    public BankCardPay doQuerypay(BankCardPay BankCardPay, PayChannelInf qrChannelInf) {
        try {
            ...
            params.put("P2_orderId", BankCardPay.getOut_trade_no());
    ...
    public String saveResultNotify(Map<String, String> resultMap) {
        BankCardPay notifyBeanTemp = this.bankCardPayDao.getById(resultMap.get("rt5_orderId"));
        ...
        String checkSign = MD5Util.getHelibaoMd5Sign(resultMap, payChannelInf.getSecret_key(), "UTF-8").toLowerCase();
