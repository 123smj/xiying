 ...
 * 商户数据类
 */
public class MerchantInf implements Serializable {
    ...
    private Double daikou_fee_value;
    ...
    private Integer daikou_fee_limit_value;
    ...
    private String daikou_need_check;

    public Double getDaikou_fee_value() {
        return this.daikou_fee_value;
    }

    public void setDaikou_fee_value(Double daikou_fee_value) {
        this.daikou_fee_value = daikou_fee_value;
    }

    public Integer getDaikou_fee_limit_value() {
        return this.daikou_fee_limit_value;
    }

    public void setDaikou_fee_limit_value(Integer daikou_fee_limit_value) {
        this.daikou_fee_limit_value = daikou_fee_limit_value;
    }

    public String getDaikou_need_check() {
        return this.daikou_need_check;
    }

    public void setDaikou_need_check(String daikou_need_check) {
        this.daikou_need_check = daikou_need_check;
    }
