...
extends PayDetail {
    ...
    private String yzm;
    private String isAcceptYzm;
    private String token_id;
    private String callback_url;
    private String limit_credit_p;
    ...
    private String send_packge;

    public String getSend_packge() {
        return this.send_packge;
    }

    public void setSend_packge(String send_packge) {
        this.send_packge = send_packge;
    }
    ...
    public String getLimit_credit_p() {
        return this.limit_credit_p;
    }

    public void setLimit_credit_p(String limitCreditP) {
        this.limit_credit_p = limitCreditP;
    }
    ...
    public Boolean isSuccess(){
        return this.trade_state.equals(TradeStateEnum.SUCCESS.getCode());
    }
}
