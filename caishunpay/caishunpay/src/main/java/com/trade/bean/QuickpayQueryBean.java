...
public class QuickpayQueryBean {
    ...
    public void setMcht_id(String mchtId) {
        this.mcht_id = mchtId;
    }
    ...
    public void setSettle_fee(String settleFee) {
        this.settle_fee = settleFee;
    }

    public String getMcht_rate() {
        return this.mcht_rate;
    }

    public void setMcht_rate(String mchtRate) {
    ...
    public void setRate_fee(String rateFee) {
