...
//
//import com.trade.util.ninepi.SimpleFastDateFormat;
...
//    static final double DAY_MILLIS = 8.64E7;
...
//        if (!StringUtils.isBlank((String)dateStr) && !StringUtils.isBlank((String)pattern)) {
//            try {
...
//        cale.set(13, 0);
//        cale.set(14, 0);
//        return cale.getTime().getTime() / 1000L;
//    }
//
...
//        return Double.valueOf(endTime - beginTime) / 8.64E7;
//    }
//
