 ...
 *  com.gy.util.MD5Encrypt
 *  com.gy.util.MapKeyComparator
 *  com.gy.util.MapValueComparator
...
public class MD5Util {
    ...
    public static Map<String, Object> sortMapByKey(Map<String, ? extends Object> map) {
        if (map == null || map.isEmpty()) {
            return null;
        }
        TreeMap<String, Object> sortMap = new TreeMap<>((Comparator<String>) new MapKeyComparator());
        sortMap.putAll(map);
        return sortMap;
    }

    public static String generateMd5(String charset, String... strs) {
        ...
        try {
            ...
            return MD5Encrypt.getMessageDigest(sb.toString(), charset);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static String md5Sign(String str){
        try {
            log.info("Before MD5 Signature:" + str);
            return MD5Encrypt.getMessageDigest(str, "UTF-8");
        }catch (Exception e){
            log.error("when md5sign",e);
            throw new RuntimeException("cannot sign");
        }
    }

    public static /* varargs */ String md5Sign(Map<String, ?> param, String secretKey, String... charset) {
        if (param == null) {
            return "";
        }
        ...
        try {
            signValue = MD5Encrypt.getMessageDigest((String) sb.toString(), (String[]) charset).toUpperCase();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static /* varargs */ String md5Sign(Map<String, ?> param, String charset) {
        if (param == null) {
            return "";
        }
        StringBuffer sb = new StringBuffer();
...
//                va
        ...
        String sb2 = sb.substring(0, sb.length() - 1).toString();
        System.out.println("\u52a0\u5bc6\u524d\uff1a" + sb2);
        log.info("\u52a0\u5bc6\u524d\uff1a" + sb2);
        String signValue = null;
        try {
            signValue = MD5Encrypt.getMessageDigest(sb2, charset).toUpperCase();
        } catch (Exception e) {
            e.printStackTrace();
        }
        log.info((Object) ("\u7cfb\u7edf\u6821\u9a8c\u7b7e\u540d\uff1a" + signValue));
    ...
    public static /* varargs */ String md5SignNokey(Map<String, ?> param, String secretKey, String... charset) {
        if (param == null) {
            return "";
        }
        StringBuffer sb = new StringBuffer();
        ...
        for (Map.Entry<String, ?> entry : param.entrySet()) {
            value = entry.getValue().toString();
            if (!StringUtil.isNotEmpty((String[]) new String[]{value})) continue;
            sb.append(entry.getKey()).append("=").append(value).append("&");
        }
        String signData = sb.substring(0, sb.length() - 1) + secretKey;
        System.out.println("加密前：" + signData);
        log.info((Object) ("加密前：" + signData));
        String signValue = null;
        try {
            signValue = MD5Encrypt.getMessageDigest((String) (String.valueOf(signData)), (String[]) charset).toLowerCase();
        } catch (Exception e) {
            e.printStackTrace();
        }
        log.info((Object) ("签名后 : " + signValue));
        return signValue;
    }

    public static /* varargs */ String md5KeyedSign(Map<String, Object> param, String secretKey, String... charset) {
        if (param == null) {
            return "";
        }
        StringBuffer sb = new StringBuffer();
        ...
        String signValue = null;
        try {
            signValue = MD5Encrypt.getKeyedDigest((String) signData, (String) secretKey, (String[]) charset);
        } catch (Exception e) {
            e.printStackTrace();
        }
        log.info((Object) ("\u7cfb\u7edf\u6821\u9a8c\u7b7e\u540d\uff1a" + signValue));
    ...
    public static /* varargs */ String md5SignWithValue(Map<String, Object> param, String secretKey, String... charset) {
        StringBuffer sb = new StringBuffer();
        for (Map.Entry<String, Object> entry : param.entrySet()) {
    ...
    public static String md5SignZhihuifu(Map<String, String> param, String secretKey, String... charset) {
        if (param == null) {
            return "";
        }
        Map param2 = sortMapByKey(param);
        StringBuilder sb = new StringBuilder();
        for (Object entry2 : param2.entrySet()) {
            Map.Entry<String, Object> entry = (Map.Entry<String, Object>) entry2;
            String sValue;
            ...
            sb.append(entry.getKey()).append("=").append(sValue).append("&");
        }
        String signData = sb.substring(0, sb.length() - 1);
        signData = signData + secretKey;
        System.out.println("\u52a0\u5bc6\u524d\uff1a" + signData);
        log.info("\u52a0\u5bc6\u524d\uff1a" + signData);
        String signValue;
        try {
            byte[] bsign = MD5Encrypt.getMessageBytes(signData, charset);
            String signString = Base64.encode(bsign);
            return signString;
    ...
    public static String md5SignZhiWu(Map<String, String> param, String secretKey, String... charset) {
        if (param == null) {
            return "";
        }
        Map param2 = sortMapByKey(param);
        ...
        String signData = sb.substring(0, sb.length() - 1);
        signData = signData + "&KEY=" + secretKey;
        System.out.println("\u52a0\u5bc6\u524d\uff1a" + signData);
        log.info("\u52a0\u5bc6\u524d\uff1a" + signData);
        try {
            return MD5Encrypt.getMessageDigest(signData, charset).toLowerCase();
        } catch (Exception ignored) {
            return null;
        }
    }
    ...
    public static String map2HttpParam(Map<String, String> param) {
        ...
        for (Map.Entry<String, String> entry : param.entrySet()) {
            ...
            sb.append(entry.getKey()).append("=").append(StringUtil.trans2Str(entry.getValue()));
        }
        return sb.toString();
    }
    ...
    public static String getMd5Sign(Object obj, String secretKey) {
        ...
        return MD5Util.md5Sign(MD5Util.sortMapByKey(param), secretKey, new String[0]);
    }

    public static /* varargs */ String getMd5SignByMap(Map<String, ?> map, String secretKey, String... charset) {
        return MD5Util.md5Sign(MD5Util.sortMapByKey(map), secretKey, charset);
    }

    public static /* varargs */ String getMd5SignNoKeyByMap(Map<String, String> map, String secretKey, String... charset) {
        return MD5Util.md5SignNokey(MD5Util.sortMapByKey(map), secretKey, charset);
    }

    public static /* varargs */ String getMd5KeyedSignByMap(Map<String, String> map, String secretKey, String... charset) {
        return MD5Util.md5KeyedSign(MD5Util.sortMapByKey(map), secretKey, charset);
    }

    public static /* varargs */ String getMd5SignWithValueByMap(Map<String, String> map, String secretKey, String... charset) {
        return MD5Util.md5SignWithValue(MD5Util.sortMapByKey(map), secretKey, charset);
    }

    public static /* varargs */ String getHelibaoMd5Sign(Map<String, String> map, String secretKey, String... charset) {
        return MD5Util.md5SignHelibao(map, secretKey, charset);
    }
    ...
    public static String wezbankSign(List<String> values, String signTicket) {
        ...
        try {
            ...
            String sign = StringUtil.byte2hex((byte[]) md.digest());
            return sign;
        } catch (Exception e) {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        BankPayResponse backNotify = new BankPayResponse();
        backNotify.setBankName("\u519c\u4e1a\u94f6\u884c");
        backNotify.setCardType("01");
        backNotify.setChannelType("1");
        backNotify.setMerchantId("fzh001170001");
        ...
        String checksign = MD5Util.getMd5Sign((Object) backNotify, "35e1d5f97e404606a700b7a9c237007a");
        ...
        String sign = MD5Encrypt.getMessageDigest((String) check, (String[]) new String[]{"UTF-8"}).toUpperCase();
        ...
        System.out.println(765599797);
        String[] list = new String[]{"83863120010"};
        String sql = MD5Util.createJumpSql(list, "yaku", "groupBeiy1", "\u5907\u7528\u901a\u905330\u4e2a");
    ...
    public static String createJumpSql(String[] mchtList, String jumpGroup, String GroupName) {
        ...
        while (n2 < n) {
            ...
            sb.append("values ('" + jumpGroup + "', '" + GroupName + "', '21', 'guangda', '" + mcht + "', 1);\n");
            sb.append("insert into trade_jump_list (JUMP_GROUP, GROUP_NAME, TRADE_SOURCE, CHANNEL_ID, CHANNEL_MCHT_NO, WEIGHT) ");
            sb.append("values ('" + jumpGroup + "', '" + GroupName + "', '2', 'guangda', '" + mcht + "', 1);\n");
            sb.append("insert into trade_jump_list (JUMP_GROUP, GROUP_NAME, TRADE_SOURCE, CHANNEL_ID, CHANNEL_MCHT_NO, WEIGHT) ");
            sb.append("values ('" + jumpGroup + "', '" + GroupName + "', '4', 'guangda', '" + mcht + "', 1);\n");
            ++n2;
        }
        return sb.toString();
    }

    public static String createJumpSql(String[] mchtList, String channelId, String jumpGroup, String GroupName) {
        StringBuffer sb = new StringBuffer();
        String[] arrstring = mchtList;
        int n = arrstring.length;
        int n2 = 0;
        while (n2 < n) {
            String mcht = arrstring[n2];
            sb.append("insert into trade_jump_list (JUMP_GROUP, GROUP_NAME, TRADE_SOURCE, CHANNEL_ID, CHANNEL_MCHT_NO, WEIGHT) ");
            sb.append("values ('" + jumpGroup + "', '" + GroupName + "', '1', '" + channelId + "', '" + mcht + "', 1);\n");
            sb.append("insert into trade_jump_list (JUMP_GROUP, GROUP_NAME, TRADE_SOURCE, CHANNEL_ID, CHANNEL_MCHT_NO, WEIGHT) ");
            sb.append("values ('" + jumpGroup + "', '" + GroupName + "', '2', '" + channelId + "', '" + mcht + "', 1);\n");
            ++n2;
        }
        return sb.toString();
    }

    public static String createNewZhongxinJumpSql(String[] mchtList, String jumpGroup, String GroupName) {
        StringBuffer sb = new StringBuffer();
        String[] arrstring = mchtList;
        int n = arrstring.length;
        int n2 = 0;
        while (n2 < n) {
            String mcht = arrstring[n2];
            sb.append("insert into trade_jump_list (JUMP_GROUP, GROUP_NAME, TRADE_SOURCE, CHANNEL_ID, CHANNEL_MCHT_NO, WEIGHT) ");
            sb.append("values ('" + jumpGroup + "', '" + GroupName + "', '1', 'zhongxin', '" + mcht + "', 1);\n");
            sb.append("insert into trade_jump_list (JUMP_GROUP, GROUP_NAME, TRADE_SOURCE, CHANNEL_ID, CHANNEL_MCHT_NO, WEIGHT) ");
            sb.append("values ('" + jumpGroup + "', '" + GroupName + "', '2', 'zhongxin', '" + mcht + "', 1);\n");
            ++n2;
        }
        return sb.toString();
    }
    ...
    public static Map mappingParameterMap(Map map) {
