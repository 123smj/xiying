...
public class RateInfo {
    ...
    private String rate_type;//价格类型
    private Double debit_card_fee_value;//借卡人的消费值
    private Double debit_card_max_fee;//借卡人的最大消费
    private Double credit_card_fee_value;//信用卡消费值
    private Double wechat_fee_value;//微信消费值
    private Double alipay_fee_value;//支付宝消费值
    private Double qq_fee_value;//qq消费值
    private Double quickpay_fee_value;//核心消费值
    private Double netpay_fee_value;
    private Double aliwap_fee_value;
    private Double wechatwap_fee_value;//
    private Integer single_extra_fee;//一笔临时消费
