...
public class OprInfo {
    private String opr_id;//操作者的ID
    private String company_id;//公司ID
    private Integer opr_degree;//操作者的等级
    private String opr_sta;//操作者的状态
    private String opr_name;//操作者的姓名
    private String opr_gender;//操作者的性别
    private String register_dt;//登记
    private String opr_pwd;//操作者的密码
    private String opr_mobile;//操作者的电话
    private String opr_email;//操作者的邮箱
    private String last_upd_ts;//修改人名
    private String company_name;//公司名
    private String address;//地址
    private String connact_name;//账号名
    private String identify_no;//确定值
    private String opr_type;//操作者的类型
