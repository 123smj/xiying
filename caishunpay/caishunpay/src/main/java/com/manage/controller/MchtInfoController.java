...
//    private WxpayService wxpayServiceImpl;
    ...
    @ResponseBody
    public PageModle<MerchantInf> mchtQuery(HttpServletRequest request) {
        OprInfo oprInfo = (OprInfo)request.getSession().getAttribute("oprInfo");
        PageModle<MerchantInf> pageModle = null;
        try {
            int pageNum = 1;
            ...
            pageModle = this.merchantInfServiceImpl.listMchtInfoByPage(param, pageNum, 10, oprInfo);
        }
        catch (Exception e) {
            e.printStackTrace();
    ...
    public ModelAndView mchtQuerySingle(HttpServletRequest request, String mchtNo) {
        ...
        try {
            MerchantInf mchtInfo = this.merchantInfServiceImpl.getMchtInfo(mchtNo);
    ...
    @ResponseBody
    public String mchtAdd(HttpServletRequest request, MerchantInf mchtInfo) {
        block7 : {
            OprInfo oprInfo = (OprInfo)request.getSession().getAttribute("oprInfo");
            try {
        ...
        this.merchantInfServiceImpl.saveMchtInfo(mchtInfo, tradeMchtAccount);
    ...
    @ResponseBody
    public String mchtAccept(HttpServletRequest request, MerchantInf paramMchtInfo) {
        OprInfo oprInfo = (OprInfo)request.getSession().getAttribute("oprInfo");
        try {
            ...
            MerchantInf realMchtInfo = this.merchantInfServiceImpl.getMchtInfo(paramMchtInfo.getMchtNo());
            ...
            if (MchtStatusEnum.ADD.getCode().equals(tempMchtInfoTmp.getStatus())) {
                ...
                MerchantInf newMcht = new MerchantInf();
                ...
                if (CommonFunction.isTradeSourceOpen(newMcht.getTrade_source_list(), TradeSource.BANLANCE_DAIFU)) {
                ...
                this.merchantInfServiceImpl.saveMchtInfo(newMcht);
                ...
                if (CommonFunction.isTradeSourceOpen(realMchtInfo.getTrade_source_list(), TradeSource.BANLANCE_DAIFU)) {
                ...
                this.merchantInfServiceImpl.updateMchtInfo(realMchtInfo);
            }
    ...
    private void sendMchtInfoToManager(MerchantInf mchtInfo) {
        ...
        content.append("    \u60a8\u7684\u5546\u6237\u5df2\u7ecf\u6ce8\u518c\u6210\u529f.\n    \u5546\u6237\u53f7:" + mchtInfo.getMchtNo() + "\n    \u4ea4\u6613\u5bc6\u94a5:" + mchtInfo.getSecretKey() + "\n    \u767b\u5f55\u7f51\u5740:" + SysParamUtil.getParam("MCHT_LOGIN_URL") + "\n    \u767b\u5f55\u5e10\u53f7:" + mchtInfo.getMchtNo() + "\n    \u767b\u5f55\u5bc6\u7801:" + mchtInfo.getIdentity_no().substring(mchtInfo.getIdentity_no().length() - 6) + "\n    \u672c\u90ae\u4ef6\u4e3a\u52a0\u5bc6\u90ae\u4ef6.");
        try {
    ...
    @ResponseBody
    public String mchtUpdate(HttpServletRequest request, MerchantInf mchtInfo) {
        OprInfo oprInfo;
        MerchantInf mchtInfoOld;
        block4 : {
            oprInfo = (OprInfo)request.getSession().getAttribute("oprInfo");
            try {
                String checkResult = this.checkMcht(mchtInfo);
                ...
                mchtInfoOld = this.merchantInfServiceImpl.getMchtInfo(mchtInfo.getMchtNo());
        ...
        this.merchantInfServiceImpl.updateMchtInfo(mchtInfoOld);
        return ResponseEnum.SUCCESS.getCode();
    }

    @RequestMapping(value = {"/mchtFreeze"}
//            ,produces={"application/json; charset=utf-8"}
    )
    @ResponseBody
    public String mchtFreeze(HttpServletRequest request, String mchtNo) {
        MerchantInf mchtInfo;
        OprInfo oprInfo;
        block5 : {
            block4 : {
                oprInfo = (OprInfo)request.getSession().getAttribute("oprInfo");
                try {
                    mchtInfo = this.merchantInfServiceImpl.getMchtInfo(mchtNo);
        ...
        this.merchantInfServiceImpl.updateMchtInfo(mchtInfo);
        return ResponseEnum.SUCCESS.getCode();
    }

    @RequestMapping(value = {"/mchtRecover"}
//    , produces={"application/json; charset=utf-8"}
    )
    @ResponseBody
    ...
    public String mchtExport(HttpServletRequest request) {
        OprInfo oprInfo = (OprInfo)request.getSession().getAttribute("oprInfo");
        List<MerchantInf> mchtList = null;
        ...
        try {
            Map param = this.buildRequestParam(request);
            mchtList = this.merchantInfServiceImpl.listAllMcht(param, oprInfo);
    ...
    private String generateTradeFile(List<MerchantInf> tradeList, String filePath) {
        File tradeFile = new File(filePath);
        try {
            FileChannel fileChannel = new FileOutputStream(tradeFile).getChannel();
            StringBuffer sBuffer = new StringBuffer();
            sBuffer.append("\u6ce8\u518c\u65f6\u95f4,\u5546\u6237\u7f16\u53f7,\u5546\u6237\u540d\u79f0,\u516c\u53f8\u7f16\u53f7,\u516c\u53f8\u540d\u79f0,\u624b\u673a\u53f7,\u90ae\u7bb1,\u8eab\u4efd\u8bc1\u53f7,\u6e20\u9053\u7f16\u53f7,\u6e20\u9053\u5546\u6237,\u7ed3\u7b97\u5361\u53f7,\u7ed3\u7b97\u94f6\u884c,\u7ed3\u7b97\u4eba,\u8054\u884c\u53f7,\u5546\u6237\u5730\u5740,\u5fae\u4fe1\u626b\u7801\u8d39\u7387(%),\u5fae\u4fe1wap\u8d39\u7387(%),\u652f\u4ed8\u5b9d\u8d39\u7387(%),\u652f\u4ed8\u5b9dwap\u8d39\u7387(%),\u5feb\u6377\u652f\u4ed8\u8d39\u7387(%),\u7f51\u94f6\u652f\u4ed8\u8d39\u7387(%),\u5355\u7b14\u4ee3\u4ed8\u8d39/\u5143,\u5f00\u901a\u4e1a\u52a1\u7c7b\u578b");
            sBuffer.append("\n");
            for (MerchantInf mchtBean : tradeList) {
                ...
                sBuffer.append(",'").append(StringUtil.trans2Str(mchtBean.getCompanyName()));
                ...
                sBuffer.append(",'").append(StringUtil.trans2Str(mchtBean.getWechatwap_fee_value()));
                sBuffer.append(",'").append(StringUtil.trans2Str(mchtBean.getAlipay_fee_value()));
                sBuffer.append(",'").append(StringUtil.trans2Str(mchtBean.getAliwap_fee_value()));
                ...
                sBuffer.append(",'").append(StringUtil.trans2Str(StringUtil.changeF2Y(mchtBean.getSingle_extra_fee() == null ? 0 : mchtBean.getSingle_extra_fee())));
    ...
    private String checkMcht(MerchantInf mchtInfo) {
        if (mchtInfo == null) {
            return "\u53c2\u6570\u6709\u8bef";
        }
