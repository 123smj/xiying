...
<div>
	...
	function accountDetailQuery(num){
		...
		$.ajax({
            cache: true,
            type: "POST",
            url:"manage/accountIncomeDetail?r=" + new Date().getTime(),
            ...
            success: function(data) {
	            ...
	            $("#totalAmount").html("交易总额:" + data.totalAmount + "元");
	            $("#totalFee").html("手续费:" + data.totalFee + "元");
	            $("#accountNum").html("进账金额:" + data.accountNum + "元");
                ...
                for(var i=0; i<data.data.length; i++){
                	...
                	fenToYuan(item.totalAmount) + '</td><td>' +
                	fenToYuan(item.mchtFeeValue) + '</td><td>' +
                	fenToYuan(item.mchtIncome);
