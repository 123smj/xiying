...
<div id="loading" class="loading" style="">Loading pages...</div>  
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="netpay/applyPay.do" method="post" id="loginForm">
                <div class="form-group">
                    <label>商户号</label>
                    
                    <input type="text" class="form-control span12" name="merchantId" id="merchantId" value="9010001011">
                </div>
                <div class="form-group">
                    <label>订单号</label>
                ...
                <div class="form-group">
                    <label>交易金额</label>
                    <input type="text" class="form-control span12" name="orderAmount" id="orderAmount" value="14">
                </div>
                <div class="form-group">
                    <label>商品名称</label>
