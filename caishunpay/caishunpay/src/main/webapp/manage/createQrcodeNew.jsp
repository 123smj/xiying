...
<div id="loading" class="loading" style="">Loading pages...</div>  
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="new/getNativeUrl.do" method="post" id="loginForm">
                <div class="form-group">
                    <label>商户号</label>
                    
                    <input type="text" class="form-control span12" name="merchantId" id="merchantId" value="6220002151">
                </div>
                <div class="form-group">
                    <label>订单号</label>
                    <input type="text" class="form-control span12" name="tradeSn" id="tradeSn" value="20170215164816">
                </div>
                <div class="form-group">
                    <label>交易金额</label>
