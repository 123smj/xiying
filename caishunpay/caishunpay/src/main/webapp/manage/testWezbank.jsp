    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="quickpay/checkPay.do" method="post" id="loginForm">
                ...
                <div class="form-group">
                    <label>订单号</label>
                    <input type="text" class="form-control span12" name="tradeSn" id="tradeSn" value="201703031648161">
                </div>
                <div class="form-group">
                    <label>交易金额</label>
                ...
                <div class="form-group">
                    <label>商户名称</label>
                    <input type="text" class="form-control span12" name="goodsName" id="goodsName" value="测试快捷支付">
                </div>
                <div class="form-group">
                    <label>持卡人姓名</label>
                ...
                <div class="form-group">
                    <label>联行号</label>
                    <input type="text" class="form-control span12" name="bankCode" id="bankCode" value="308581002345">
                </div>
                <div class="form-group">
                    <label>银行名称</label>
    ...
    function getYzmFunc(){
		...
		setTimeout(function(){
			$.ajax({
	            ...
	            type: "POST",
	            timeout: 10000,
	            url:"getToken.do?r=" + new Date().getTime(),
